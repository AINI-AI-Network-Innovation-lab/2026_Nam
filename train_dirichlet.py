...
def main():
    ...
    print("[Server] Đang tải mô hình ban đầu cho phiên bản Dirichlet (Non-IID)...")
    ...
    print(f"\nBắt đầu Giai đoạn HỌC TẬP (DATASET: DIRICHLET SKEW)")
    ...
    history = fl.simulation.start_simulation(
        ...
        ray_init_args={"num_gpus": 2} # Chỉnh lại nếu phần cứng của bạn khác
    )
    ...
    # Đổi tên file để không ghi đè lên kịch bản IID gốc
    output_filename = "trained_model_weights1.5B_dirichlet.npz"
    np.savez(output_filename, *weights)
    print(f"\nGiai đoạn HỌC TẬP hoàn tất. Trọng số đã được lưu vào '{output_filename}'")
